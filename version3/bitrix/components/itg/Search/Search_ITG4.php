...
class Search_ITG
{
    ...
    
    {
         ...
         foreach($arItem as $Id=>$Item)
         {
             ...
             if ($Item['RegionCode']<=4 || $Item['RegionCode']==1000 || $Item['RegionCode']==997 || $Item['RegionCode']==999 || $Item['RegionCode']==995 )
             {
               $OldItemsRemain[]= $Item; 
             }
             else
    ...
    private function prepareSql()
    {
        ...
        $this->params['fieldsUnion'] = " 
                                    ...
                                    (SELECT IF (`RegionCode`=1 OR `RegionCode`=1000 OR `RegionCode`=2 ,`Quantity`,10 )) AS Quantity, 
