...
<body>
	...
	<div class="inner-header">
		<div class="container">
			<div class="pull-left">
				<h6 class="inner-title">Калькулятор ТО </h6>
			</div>
			<div class="pull-right">
				<div class="beta-breadcrumb font-large">
					<a href="index.php">Главная</a> / <span> Калькулятор ТО</span>
				</div>
			</div>
			<div class="clearfix"></div>
		</div>
	...
	<div class="space50">&nbsp;</div>
					...
					<tfoot>
						<tr>
							<td colspan="6" class="actions">
								...
								<div class="coupon">
									<button type="submit" class="beta-btn primary" name="apply_coupon" align="center" >Поиск аналогов <i class="fa fa-chevron-right"></i></button>
								</div>
			...
			<div class="col-sm-4 aside">
					<div class="widget">
						<h3 class="widget-title">Калькулятор ТО</h3>
						<div class="widget-body">
							<ul class="list-unstyled">
								...
								<li class="hidden-xl">
									<select name="Модель">
										<option value="ru">Avensis</option>
										<option value="ro">Camry</option>
									</select>
								</li>
								<li class="hidden-xl">
									<select name="Тип модели">
										<option value="ru">1.8</option>
										<option value="ro">2.0 D</option>
									</select>
								</li>
								<li class="hidden-xl">
									<select name="Пробег">
