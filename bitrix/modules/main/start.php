...
#-------------------Add new code ------------
$GLOBALS["DBR"] = new CDatabase;
$GLOBALS["DBR"]->debug = $DBDebug;
$GLOBALS["DBR"]->DebugToFile = $DBDebugToFile;
...
$GLOBALS["DBR"]->ShowSqlStat = ($show_sql_stat == "Y");

if(!defined("POST_FORM_ACTION_URI"))
{
	define("POST_FORM_ACTION_URI",htmlspecialchars($_SERVER["REQUEST_URI"]));
}
if(!($GLOBALS["DB"]->Connect($DBHost, $DBName, $DBLogin, $DBPassword)) || !($GLOBALS["DBR"]->Connect($DBHost, $DBNameR, $DBLogin, $DBPassword)))
{
